...
import 'package:kabor_driver/features/add_photo/add_photo.dart';
import 'package:kabor_driver/features/address/presentation/presentation.dart';
import 'package:kabor_driver/features/all_services/all_services.dart';
import 'package:kabor_driver/features/authentication/login/login.dart';
import 'package:kabor_driver/features/authentication/register/register.dart';
import 'package:kabor_driver/features/book_service/views/book_service_page.dart';
import 'package:kabor_driver/features/book_table/book_table.dart';
import 'package:kabor_driver/features/booking_checkout/views/booking_checkout_page.dart';
import 'package:kabor_driver/features/categories/categories.dart';
import 'package:kabor_driver/features/categories_details/views/categories_details_page.dart';
import 'package:kabor_driver/features/chat/views/chat_page.dart';
import 'package:kabor_driver/features/earning_list/views/earning_list_page.dart';
import 'package:kabor_driver/features/earnings/views/earnings_page.dart';
import 'package:kabor_driver/features/express_pay/views/express_pay_page.dart';
import 'package:kabor_driver/features/food/food.dart';
import 'package:kabor_driver/features/landing/view/landing_page.dart';
import 'package:kabor_driver/features/menu/menu.dart';
import 'package:kabor_driver/features/menu/payment/presentation/send_fund/send_fund.dart';
import 'package:kabor_driver/features/menu/presentation/refer/view/refer_page.dart';
import 'package:kabor_driver/features/menu/presentation/support/view/support_page.dart';
import 'package:kabor_driver/features/menu/presentation/trip_details/trip_details.dart';
import 'package:kabor_driver/features/menu/presentation/trips/view/trips_page.dart';
import 'package:kabor_driver/features/menu/settings/presentation/cards/cards.dart';
import 'package:kabor_driver/features/menu/settings/presentation/drive/drive.dart';
import 'package:kabor_driver/features/menu/settings/presentation/edit_profile/edit_profile.dart';
import 'package:kabor_driver/features/menu/settings/presentation/legal/legal.dart';
import 'package:kabor_driver/features/notifications/views/notification_page.dart';
import 'package:kabor_driver/features/onboarding/view/onboarding_page.dart';
import 'package:kabor_driver/features/pages/pages.dart';
import 'package:kabor_driver/features/payment/views/add_card_page.dart';
import 'package:kabor_driver/features/payment/views/payment_info_page.dart';
import 'package:kabor_driver/features/promo_code/views/promo_code_page.dart';
import 'package:kabor_driver/features/reviews/views/reviews_page.dart';
import 'package:kabor_driver/features/reward/presentation/presentation.dart';
import 'package:kabor_driver/features/ride/help/help.dart';
...
import 'package:kabor_driver/features/ride/selection/presentation/view/rider_page.dart';
import 'package:kabor_driver/features/schedule_event/presentation/view/schedule_event_page.dart';
import 'package:kabor_driver/features/search/presentation/presentation.dart';
import 'package:kabor_driver/features/tab/tab.dart';
import 'package:kabor_driver/features/total_bookings/views/total_bookings_page.dart';
import 'package:kabor_driver/features/total_bookings_details/views/total_bookings_details_page.dart';
import 'package:kabor_driver/features/welcome/welcome.dart';
  ...
  static List<GoRoute> routes = <GoRoute>[
    ...
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          path: AppRoutePaths.myCar,
          name: AppRoutes.myCar,
          builder: (BuildContext context, GoRouterState state) {
            return const MyCarPage();
          },
        ),
        GoRoute(
          path: AppRoutePaths.myCarDetails,
          name: AppRoutes.myCarDetails,
          builder: (BuildContext context, GoRouterState state) {
            return const MyCarDetailsPage();
          },
        ),
        GoRoute(
