...
import 'package:kabor_driver/core/router/app_route_paths.dart';
import 'package:kabor_driver/core/theme/src/app_colors.dart';

class CategoriesDetailsCard extends StatelessWidget {
  const CategoriesDetailsCard({Key? key}) : super(key: key);
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        return GestureDetector(
          onTap: () => context.pushNamed(AppRoutePaths.subcategoriesDetails),
          child: Container(
            height: 230,
            width: 169,
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: const DecorationImage(
                          image: AssetImage('assets/images/manicure.png'),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
